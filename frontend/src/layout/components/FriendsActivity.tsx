...
const FriendsActivity = () => {
	...
	return (
		<div className='h-full bg-gradient-to-b from-[#334eac] to-zinc-900 rounded-lg flex flex-col'>
				...
				<div className='p-4 space-y-4'>
					{users.map((user) => {
						...
						return (
							<div
								key={user._id}
								className='cursor-pointer hover:bg-[#334eac] p-3 rounded-md transition-colors group'
							>
								<div className='flex items-start gap-3'>
									...
									<div className='flex-1 min-w-0'>
										...
										{isPlaying ? (
											...
											<div className='mt-1 text-xs text-slate-200'>Idle</div>
										)}
									</div>
								</div>
							</div>
